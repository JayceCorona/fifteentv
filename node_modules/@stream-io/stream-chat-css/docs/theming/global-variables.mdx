...
- **Theme**: colors, typography and border radiuses ([list of global theme variables](https://github.com/GetStream/stream-chat-css/tree/v5.1.1/src/v2/styles/_global-theme-variables.scss))

- **Layout**: spacing (padding and margin) and sizing ([list of global layout variables](https://github.com/GetStream/stream-chat-css/tree/v5.1.1/src/v2/styles/_global-layout-variables.scss))
